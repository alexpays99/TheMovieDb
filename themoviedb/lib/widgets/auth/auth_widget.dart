...
class _HeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding( // отступы для колонки с текстами
...
class __FormWidgetState extends State<_FormWidget> {
  final _loginTextController = TextEditingController(); // контроллер для логина
  final _passwordTextController = TextEditingController(); // контроллер для пароля
  ...
  Widget build(BuildContext context) {
    ...
    final textFieldDecorator = const InputDecoration( // рамка для формы
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start, // прижать все к правому краю.
      children: [
        if(errorText != null) ...[
          Text(
            errorText,
